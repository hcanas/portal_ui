<template>
  <div class="w-5/6 h-full flex flex-col bg-white rounded">
    ...
    <div class="flex-grow flex">
      ...
      <div :class="{ 'w-1/3 pr-8 pt-8': offices.show }" class="flex-shrink-0 transition">
        <ag-grid-vue v-show="offices.show"
